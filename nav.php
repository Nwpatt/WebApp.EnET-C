...
?>
    <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #D3D3D3;">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a href="login.php" class="nav-link"><i class="bi bi-pencil-square pe-2"></i>เข้าสู่ระบบ</a>
                </li>
            </ul>
        </div>
    </nav>
            ...
            <ul class="navbar-nav">
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="button1">
                        <li>
                            <a href="logout.php" class="dropdown-item"><i class="bi bi-power pe-2"></i>ออกจากระบบ</a>
                        </li>
                    </ul>
                </div>
            </ul>
